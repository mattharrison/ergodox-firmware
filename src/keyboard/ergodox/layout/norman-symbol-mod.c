/* ----------------------------------------------------------------------------
 * ergoDOX layout : NORMAN (modified from the Kinesis layout)
 * 
...
const uint8_t PROGMEM _kb_layout[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
    ...
    2,          _J,         _U,         _R,         _L,         _semicolon, _backslash,
                _Y,         _N,         _I,         _O,         _H,         _quote,
    1,          _P,         _M,         _comma,     _period,    _slash,     _shiftR,
                            _arrowU,    _arrowD,    _bracketL,  _bracketR,  _altR,
